...
If you want to deploy a multi-node environment, verify multi-node communication as described in [Verify inter-node connectivity](../../installation.md#installation-multi-node-interconnect).
